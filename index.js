...
const sessdata = config.SESSION_ID.replace("DRACULA-MD", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = ` SALUT JE SUIS DRACULA TON BOT WHATSAPP \n\n MON PREFIX EST: = ${prefix}`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/sauy49.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('2250575130788', '2250575130788', '2250575130788');
