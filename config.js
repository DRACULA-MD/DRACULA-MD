...
module.exports = {
  ...
  AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "vue par Dracula ",
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "225342758XXXX",
  OWNER_NAME: process.env.OWNER_NAME || "PHAROUK",
  DESCRIPTION: process.env.DESCRIPTION || "SIMPLE BOT CRÉÉ PAR PHAROUK",
  ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/149k8x.jpg",
  LIVE_MSG: process.env.LIVE_MSG || "> HELLO JE SUIS EN LIGNE ",
